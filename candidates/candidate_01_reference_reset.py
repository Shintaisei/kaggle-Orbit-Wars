# Candidate 01: reference_reset
# Baseline copy of the current local 908-lineage main.py candidate.
# Public reference candidates are kept under external/ for comparison only.
