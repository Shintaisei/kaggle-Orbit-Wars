# Candidate 02: less_defense_absorption
# Based on current local 908-lineage main.py. This variant reduces rescue/absorb
# budget pressure so expansion and hammer missions are less likely to be starved.
