# Candidate 04: 4p_rank_delta
# Based on current local 908-lineage main.py. This variant is donation-averse in
# 4P: less weakest-player chasing, more leader pressure, stricter cheap expansion.
...
VALUE_WEIGHT_4P = float(os.environ.get("V126_VALUE_WEIGHT_4P", "1.8"))
...
WEAKEST_TARGET_BONUS = 0.8      
WEAKEST_TARGET_MIN_STEP = 90    
WEAKEST_DONT_FINISH_SHARE = 0.05
WEAKEST_DONT_FINISH_PENALTY = 18.0  
