# Candidate 05: endgame_hammer
# Based on current local 908-lineage main.py. This variant starts terminal and
# hammer behavior earlier, spending stockpiles more readily to close games.
...
MEGA_HAMMER_SHIPS_MIN_FRESH = 170          
...
LATE_FLUSH_REMAINING_TURNS = 35  
LATE_FLUSH_OVERKILL_RATIO = 1.12      
