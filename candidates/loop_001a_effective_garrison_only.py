# Loop 001a: effective_garrison_only
# Based on candidate_02_less_defense_absorption. This variant changes only
# target-arrival projection to resolve same-ETA fleets with official combat.
