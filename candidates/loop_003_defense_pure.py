# Loop 003: defense_pure
# Based on champion_current. This variant keeps the defense absorption and
# same-turn projection fixes, but removes mixed hammer/evac tuning from C02.
