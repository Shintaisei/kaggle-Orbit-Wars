# Loop 004a: hammer_fallback_ablation
# Based on champion_current. This changes only the global hammer fallback
# threshold; mode_params usually override it, so this is expected to be inert.
