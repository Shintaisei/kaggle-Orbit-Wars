# Loop 005a: evac_105
# Based on champion_current. This variant evacuates doomed planets slightly
# earlier by lowering the preemptive doom threshold from 1.10 to 1.05.
...
PREEMPTIVE_EVAC_DOOM_RATIO = 1.05  
