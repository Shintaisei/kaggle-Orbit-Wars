# Loop 005b: evac_100
# Based on champion_current. This variant evacuates doomed planets aggressively
# by lowering the preemptive doom threshold from 1.10 to 1.00.
...
PREEMPTIVE_EVAC_DOOM_RATIO = 1.00  
