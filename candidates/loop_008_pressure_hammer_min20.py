# Loop 008: pressure_hammer_min20
# Based on champion_current. This variant lowers only the effective 2P pressure
# mode hammer stockpile minimum from 25 to 20.
