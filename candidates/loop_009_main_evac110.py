# Loop 009: main_evac110
# Based on main.py. This variant changes only preemptive doom-evac sensitivity
# to test whether C02's evac ratio is useful against main.py.
