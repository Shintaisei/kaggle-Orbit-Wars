# Loop 014: seat_adaptive_defense
# Based on main.py. This variant uses seat-specific 2P defense knobs observed
# from gate200 diagnostics and adds central source-budget clamping.
...
class World:
    def __init__(self, obs, inferred_step=None):
        ...
        global ABSORB_MIN_THREAT, DEFENSE_COALITION_MAX
