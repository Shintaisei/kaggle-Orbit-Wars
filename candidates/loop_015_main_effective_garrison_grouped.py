# Loop 015: main_effective_garrison_grouped
# Based on main.py. This variant changes only target-arrival projection to
# resolve same-ETA fleets with official top-two combat.
