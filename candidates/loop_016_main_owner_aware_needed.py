# Loop 016: main_owner_aware_needed
# Based on loop_015. This variant avoids redundant follow-up when projected
# arrivals already make the target ours.
...
def effective_needed_to_capture(target, travel_turns, world):
    ...
    projected_owner, defender_ships = effective_garrison_at_arrival(target, travel_turns, world)
    if projected_owner == world.player:
        return 0
