# Loop 020: main_commit_drop_overbudget
# Based on main.py. This variant drops over-budget commits instead of clamping
# ship count, avoiding speed/ETA changes without re-aim.
...
def _commit_fleet(world, moves, spent, target_locked,
    ...
    if source is not None and int(ships) > int(source.ships) - int(spent[src_id]):
        return False
