...
def _commit_fleet(world, moves, spent, target_locked,
    ...
    _trace_commit_mode(world, spent, src_id, target_id, angle, turns, ships, mode_label, commit_allowed=True)
...
def _try_doom_evac(world, victim, available, spent, target_locked, moves, mode_log):
    ...
    if friendly_candidates:
        ...
        _commit_fleet(world, moves, spent, target_locked,
                      victim.id, dst.id, angle, turns, int(garrison), mode_label="doom-evac-friendly")
    ...
    _commit_fleet(world, moves, spent, target_locked,
                  victim.id, dst.id, angle, turns, int(garrison), mode_label="doom-evac-attack")
