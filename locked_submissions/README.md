...
This folder stores exact local snapshots of important Kaggle submissions.

## 53418690 - vickimar heuristic fixed

- File: `53418690_vickimar_heuristic_fixed_SCORE_908_0.py`
- Kaggle description: `public notebook vickimar heuristic fixed`
- Submitted: `2026-06-06 09:48:24.707000`
- Observed public score: `908.0`
- SHA256: `6C592F720B7C2B775CDDFCEE558B9108A4E9626CF8FE8A79E5B2E4877BE2C370`
- Source relationship: this file is an exact copy of `main.py` and `variants/vicki_fixed.py` at lock time.

Use this as the canonical snapshot of the second submission / current best public score version.

## 53439162 - Loop046 production candidate

- File: `53439162_loop046_production_candidate_PENDING.py`
...
## 53439165 - Loop021 research best 2P

- File: `53439165_loop021_research_best_2p_PENDING.py`
...
## 53439169 - Loop033 research best 4P

- File: `53439169_loop033_research_best_4p_PENDING.py`
